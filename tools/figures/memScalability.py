...
ax.plot(
    db,
    df1["Average Membership Computation (seconds)"].values,
    marker="o",
    linestyle="-",
    label="Baseline",
)
ax.plot(
    db,
    df2["Average Membership Computation (seconds)"].values,
    marker="s",
    linestyle="--",
    label="GROTE",
)
ax.plot(
    db,
    df3["Average Membership Computation (seconds)"].values,
    marker="*",
    linestyle="-",
    label="Blind-Match",
)
ax.plot(
    db,
    df4["Average Membership Computation (seconds)"].values,
    marker="^",
    linestyle="--",
    label="HERS",
)
ax.plot(
    db,
    df5["Average Membership Computation (seconds)"].values,
    marker="v",
    linestyle="-",
    label="Ours",
)
