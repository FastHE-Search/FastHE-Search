...
inline constexpr std::array<ExperimentalApproachMeta, 12> ExperimentalApproachTable = { {
  ...
  { ExperimentalApproach::FastHESearchCPU, "FastHE-Search_CPU", "Novel diagonal transform", "Diagonal" },
  ...
  { ExperimentalApproach::FastHESearchGPU, "FastHE-Search-GPU", "FastHE-Search-GPU", "FastHE-Search-GPU" },
