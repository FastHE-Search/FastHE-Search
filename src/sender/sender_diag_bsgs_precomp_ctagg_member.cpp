...
DiagonalBSGSPrecompCtAggMemberSender::DiagonalBSGSPrecompCtAggMemberSender(CryptoContext<DCRTPoly> ccParam, PublicKey<DCRTPoly> pkParam, size_t vectorParam)
: DiagonalBSGSPrecompOptSender(ccParam, pkParam, vectorParam) {
}

// -------------------- PUBLIC FUNCTIONS --------------------

Ciphertext<DCRTPoly> DiagonalBSGSPrecompCtAggMemberSender::membershipScenario(vector<Ciphertext<DCRTPoly>>& queryCipher) {
...
Ciphertext<DCRTPoly> DiagonalBSGSPrecompCtAggMemberSender::computeMembershipFused(vector<Ciphertext<DCRTPoly>>& rotatedQueryCipher, size_t numMatrices) {
