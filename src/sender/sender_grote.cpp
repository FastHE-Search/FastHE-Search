...
GroteSender::GroteSender(CryptoContext<DCRTPoly> ccParam, PublicKey<DCRTPoly> pkParam, size_t vectorParam) : BaseSender(ccParam, pkParam, vectorParam) {
}
...
vector<Ciphertext<DCRTPoly>> GroteSender::indexScenario(vector<Ciphertext<DCRTPoly>>& queryCipher) {
