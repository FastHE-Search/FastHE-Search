...
DiagonalBSGSPrecompMemberAggrCtSender::DiagonalBSGSPrecompMemberAggrCtSender(
...
Ciphertext<DCRTPoly> DiagonalBSGSPrecompMemberAggrCtSender::membershipScenario(
...
Ciphertext<DCRTPoly> DiagonalBSGSPrecompMemberAggrCtSender::computeMembershipFused(
