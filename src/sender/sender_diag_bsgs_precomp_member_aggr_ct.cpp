...
// implementation of functions declared in sender_diag_bsgs_precomp_member_aggr_ct.h
//
...
DiagonalBSGSPrecompMemberAggrCtSender::DiagonalBSGSPrecompMemberAggrCtSender(CryptoContext<DCRTPoly> ccParam, PublicKey<DCRTPoly> pkParam, size_t vectorParam)
: DiagonalBSGSPrecompOptSender(ccParam, pkParam, vectorParam) {
}

// -------------------- PUBLIC FUNCTIONS --------------------

Ciphertext<DCRTPoly> DiagonalBSGSPrecompMemberAggrCtSender::membershipScenario(vector<Ciphertext<DCRTPoly>>& queryCipher) {
...
Ciphertext<DCRTPoly> DiagonalBSGSPrecompMemberAggrCtSender::computeMembershipFused(vector<Ciphertext<DCRTPoly>>& rotatedQueryCipher, size_t numMatrices) {
