...
HersSender::HersSender(CryptoContext<DCRTPoly> ccParam, PublicKey<DCRTPoly> pkParam, size_t vectorParam) : Sender(ccParam, pkParam, vectorParam) {
}
...
Ciphertext<DCRTPoly> HersSender::computeSimilarityHelper(size_t matrixIndex, vector<Ciphertext<DCRTPoly>>& queryCipher) {
...
Ciphertext<DCRTPoly> HersSender::computeSimilaritySerial(size_t matrix, size_t index, Ciphertext<DCRTPoly>& queryCipher) {
