...
DiagonalBSGSPrecompOptSender::DiagonalBSGSPrecompOptSender(CryptoContext<DCRTPoly> ccParam, PublicKey<DCRTPoly> pkParam, size_t vectorParam)
...
Ciphertext<DCRTPoly> DiagonalBSGSPrecompOptSender::computeSimilarityMatrixPrecompOpt(vector<Ciphertext<DCRTPoly>>& rotatedQueryCipher, size_t matrix) {
